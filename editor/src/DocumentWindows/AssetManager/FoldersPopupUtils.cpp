...
namespace parallax::editor {
    ...
    void AssetManagerWindow::createFolderPopup()
    {
        ...
        if (Button("Create", ImParallax::VALIDATION) && handleFolderCreation()) {
    ...
    void AssetManagerWindow::deleteNotEmptyFolderPopup()
    {
        ...
        ImGui::Separator();
        if (Button("Delete", ImParallax::VALIDATION) && m_folderManager.deleteFolder(folderPath)) {
            m_folderActionState.reset();
            PopupManager::closePopup();
        } else {
            m_folderActionState.showError    = true;
    ...
    void AssetManagerWindow::renameFolderPopup()
    {
        ...
        if (Button("Rename", ImParallax::VALIDATION) && handleFolderRenaming(newName)) {
            m_folderActionState.reset();
            newName = "";
            PopupManager::closePopup();
            isFocus = true;
